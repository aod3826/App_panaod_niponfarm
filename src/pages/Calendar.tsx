...
export default function Calendar() {
  ...
  const TaskCard: React.FC<{ task: Task }> = ({ task }) => {
    ...
    let colorClass = isOverdue ? "bg-red-50 text-red-600 border-red-200 dark:bg-red-900/10 dark:text-red-400 dark:border-red-500/30" : 
    ...
    return (
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className={clsx("font-bold text-lg", isOverdue ? "text-red-700 dark:text-red-300" : isTodayOrTomorrow ? "text-blue-800 dark:text-blue-300" : "")}>
            ...
            <AnimatePresence>
              {showPicker && (
                <motion.div
                  ...
                  className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 bg-white dark:bg-[#1a2f3a] border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl p-4 z-50 backdrop-blur-xl"
                >
