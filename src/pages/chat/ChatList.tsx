...
export default function ChatList() {
  ...
  return (
    <div className="max-w-2xl mx-auto pb-20">
      ...
      {/* New Chat Modal */}
      {showUsersModal && (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/60 p-4 animate-in fade-in">
          <div className="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md max-h-[85vh] flex flex-col shadow-2xl animate-in slide-in-from-bottom-5">
            ...
            <div className="p-4 border-b border-gray-50">
              <div className="relative group">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 via-[#00bcd4] to-blue-500 rounded-xl opacity-0 group-focus-within:opacity-80 transition duration-1000 group-focus-within:duration-200 animate-search-glow blur-sm"></div>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50/90 backdrop-blur-xl border-none rounded-xl focus:ring-2 focus:ring-indigo-100 placeholder-gray-400 outline-none transition-all shadow-sm"
                  />
                </div>
              </div>
            </div>
