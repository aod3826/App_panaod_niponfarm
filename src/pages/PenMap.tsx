          ...
          <form onSubmit={handleSearch} className="relative group">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full pl-12 pr-4 py-3 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border border-slate-200 dark:border-white/20 rounded-xl focus:outline-none focus:border-transparent focus:ring-2 focus:ring-[#00bcd4] text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-white/50 shadow-sm transition-all"
              />
